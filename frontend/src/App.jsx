        ...
        <TransitionGroup>
          ...
          >
            <Routes>
              ...
              <Route path="/spots/:spotId/reviews/:reviewId/edit" element={<ReviewFormModal />} />
              <Route path="/sessions/:sessionId" element={<SpotDetails />} />
              <Route path="/users/:userId" element={<ProfileButton />} />
